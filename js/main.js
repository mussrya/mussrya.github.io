...
}, portfolioApp.outputContent = function (title, skills, content, port)
{
    ...
    setTimeout(function ()
    {
        $('.u-portfolioEntry').html('<div class="row-fluid"><div class="col-md-3" style="padding: 0;height: 100%;"><div class="menuBlock col-md-3"><h1 class="u-animate">'+title+'</h1><h3 class="u-animate">'+skills+'</h3><p class="u-marginTop u-animate">'+content+'</p><a href="#" class="buttonCustom"></a></div></div><div class="col-md-9"><span class="u-closeButton u-animate">X</span><div class="col-lg-12 u-animate"><div class="u-thumbnail"><img class="img-responsive" src="/portfolio/img/'+port+'/JPEG/1.jpg"></div></div><div class="col-lg-12 u-animate"><div class="u-thumbnail"><img class="img-responsive" src="/portfolio/img/'+port+'/JPEG/1.jpg"></div></div><div class="col-lg-12 u-animate"><div class="u-thumbnail"><img class="img-responsive" src="/portfolio/img/'+port+'/JPEG/1.jpg"></div></div></div></div>');
