...
}, portfolioApp.outputContent = function (title, skills, content, port)
{
    ...
    setTimeout(function ()
    {
        $('.u-portfolioEntry').html(
            '<div class="u-innerBlock"><div class="row-fluid"><span class="u-closeButton u-animate">X</span><h1 class="u-animate">' + title + '</h1> <h3 class="u-animate">' + skills + '</h3> <p class="u-marginTop u-animate">' + content + '</p></div><div class="row-fluid u-marginTop"><div class="col-lg-12 u-animate"><div class="u-thumbnail"><img class="img-responsive" src="/portfolio/img/'+port+'/1.png"></div></div><div class="col-lg-12 u-animate"><div class="u-thumbnail"><img class="img-responsive" src="/portfolio/img/'+port+'/2.png"></div></div><div class="col-lg-12 u-animate"><div class="u-thumbnail"><img class="img-responsive" src="/portfolio/img/'+port+'/3.png"></div></div></div></div>');
